...
So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-vietnamese-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `vi_VN.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `vi_VN.csv`, we will not approve it in this case.
